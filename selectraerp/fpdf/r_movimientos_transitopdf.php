...
if($row_rsu['rif']=='G200081643'){
		...
		$this->Cell(65);
		$this->Cell(100,20,'MOVIMIENTOS EN TRANSITO',0,0,'C');
		$this->Ln();
	}else{
	...
	$this->Ln();
	if($row_rsu['rif']!='G200081643'){
	$string="Movimientos En Transito";
...
*/	
		...
		$consulta="select * from selectra.movimientos_bancarios_transito as mb left join selectra.conciliacion_bancaria as cb on mb.codigo_conciliacion=cb.codigo_conciliacion where mb.codigo_conciliacion=".$conciliacion." ORDER BY mb.fecha";
