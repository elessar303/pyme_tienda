...
function Header()
{
	...
	$this->Cell(260,5,utf8_decode("PRESUPUESTO: ".date("Y")."                       RESUMEN DE EJECUCIÓN DEL PRESUPUESTO DE GASTOS A NIVEL DE PARTIDAS,                HOJA N°: ".$this->PageNo()),'LR',1,'L');
	$this->Cell(260,5,utf8_decode("GENÉRICAS, ESPECIFICAS Y SUB-ESPECIFICAS"),'LR',1,'C');
...
{
	$this->SetFont('Arial','B',10);
	$this->Cell(260,5,utf8_decode("TRIMESTRE N°: ".$trimestre. "                                                                                        (EN BOLÍVARES)                                                                             FECHA: ".date("d/m/Y")),'LBR',1,"L");
...
function imprimir_tabla($pdf,$pagina,$num_paginas,$trimestre){
	...
	$this->Cell(15,7,utf8_decode(''),'LR',0,'C');
	$this->Cell(30,7,utf8_decode('SUB-PARTIDAS'),'LR',0,'C');
	$this->Cell(35,7,'','LR',0,'C');
	$this->Cell(45,7,utf8_decode("CRÉDITO PRESUPUESTADO"),'LR',0,'C');
	$this->Cell(30,7,'','LR',0,'C');
	$this->Cell(45,7,"SALDO PARA COMPROMETER",'LR',0,'C');
	$this->Cell(20,7,"GASTOS",'LR',0,'C');
	$this->Cell(20,7,"",'LR',0,'C');
	$this->Cell(20,7,"",'LR',1,'C');

	$this->Cell(15,7,utf8_decode('PART.'),'LBR',0,'C');
	$this->Cell(9,7,utf8_decode('GEN.'),1,0,'C');
	$this->Cell(9,7,utf8_decode('ESP.'),1,0,'C');
	$this->Cell(12,7,utf8_decode('SUB.ESP.'),1,0,'C');
	$this->Cell(35,7,utf8_decode('DENOMINACIÓN'),'LBR',0,'C');
	$this->Cell(45,7,utf8_decode("MONTO ACTUALIZADO"),'LBR',0,'C');
	$this->Cell(30,7,'COMPROMISOS','LBR',0,'C');
	$this->Cell(45,7,utf8_decode("DEL CRÉDITO PRESUPUESRIO"),'LBR',0,'C');
	$this->Cell(20,7,"CAUSADOS",'LBR',0,'C');
	$this->Cell(20,7,"PAGOS",'LBR',0,'C');
	$this->Cell(20,7,"DEUDA",'LBR',1,'C');
