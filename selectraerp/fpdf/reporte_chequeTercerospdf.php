...
function datos_cheque($fila3,$oc,$odp,$fecha,$fA){
	...
	$this->Cell(50,5,utf8_decode('Nº de Cuenta : '),'LTR',0);
	$this->Cell(25,5,utf8_decode('Nº de Cheque : '),'LTR',0);
	$this->Cell(25,5,utf8_decode('Nº de orden: '),'LTR',0);
	$this->Cell(28,5,utf8_decode('Fecha de Emisión:  '),'LTR',0);
	$this->Ln();
	$this->SetFont('Arial','I',8);
	// llamado para hacer multilinea sin que haga salto de linea
        $this->SetWidths(array(60,50,25,25,28));
	$this->SetAligns(array('C','C','C','C','C'));
        $this->Setceldas(array('LRB','LRB','LRB','LRB','LRB'));
	$this->Setancho(array(5,5,5,5,5));
        $this->Row(array($nombreBanco,$cuenta,$numero,$oc,$fechaemi));
	//fin
