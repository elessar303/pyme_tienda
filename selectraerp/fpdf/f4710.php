...
function Header()
{
	...
	$this->Cell(160,5,utf8_decode("ORIGEN Y APLICACIÓN DE FONDOS"),0,0,'C');
...
function imprime_trime($pdf,$trimestre)
{
	...
	$this->Cell(25,7,'','LR',0,'C');
	$this->Cell(80,7,'','LR',0,'C');
	$this->Cell(40,7,'','LR',0,'C');
	$this->Cell(40,7,'','LR',0,'C');
	$this->Cell(50,7,utf8_decode('VARIACIÓN'),'LR',0,'C');
	$this->Cell(25,7,'','LR',1,'C');
	
	$this->Cell(25,7,'CODIGO','LR',0,'C');
	$this->Cell(80,7,utf8_decode('DENOMINACIÓN'),'LR',0,'C');
