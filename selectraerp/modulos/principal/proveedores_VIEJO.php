...
if (isset($_POST['buscar']) || $tipob != NULL) {
    ...
    $instruccion = "SELECT * FROM $tabla order by descripcion";
}
...
$smarty->assign("cabecera", array("C&oacute;d. Proveedor", $item["id_fiscal"], "Descripci&oacute;n"));
...
//**************************************************************************
$smarty->assign("option_values", array("cod_proveedor", "rif","descripcion"));
$smarty->assign("option_output", array("C&oacute;d. Proveedor", "R.I.F.", "Descripci&oacute;n"));
