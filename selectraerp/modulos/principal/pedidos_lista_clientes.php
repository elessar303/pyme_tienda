...
if (isset($_POST['buscar']) || $tipob != NULL) {
    ...
    $instruccion = "SELECT * FROM clientes where id_cliente<>0";
}
...
$hicc=$data_parametros[0]["HICC"]; 
$smarty->assign("hicc", $hicc);
$smarty->assign("registros", $campos);
$smarty->assign("cabecera", array("C&oacute;d. Cliente", "Nombre y Apellido / Raz&oacute;n Social", "C&eacute;dula / ".$item["id_fiscal"], "Tel&eacute;fonos"));
...
$smarty->assign("option_output", array($item["id_fiscal"], "C&oacute;d. Cliente", "Nombre"));
