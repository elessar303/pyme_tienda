...
if (isset($_POST['buscar']) || $tipob != NULL) {
    ...
    $instruccion = "SELECT * FROM $tabla  order by fecha desc";
}
...
$smarty->assign("cabecera", array("Nro de Cataporte", "Fecha del Dep&oacute;sito", "Monto"));
...
//**************************************************************************
$smarty->assign("option_values", array("nro_cataporte", "fecha" ));
$smarty->assign("option_output", array("Nro de Cataporte", "Fecha" ));
