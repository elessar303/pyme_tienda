...
<html>
    <head>
        ...
        <script language="JavaScript" type="text/JavaScript">
            ...
            parametros = {
                "arreglo" : checkboxValues, "opt" : "calcular_monto_deposito"
            }
    ...
    <body>
        ...
        <table style="width:50%; background-color:white;" cellpadding="1" cellspacing="1" class="seleccionLista" align="center">
                <thead>
                    <tr>
                        <th class="tb-head" style="text-align:center;" colspan="7">Generar Depositos para Punto de Venta: {$parametros[0].codigo_siga}</th>
                    </tr>
                    <tr>
                    	<td align="left">N°</td>
            		...
            		<tr >
		                ...
		                <td align="center"><input type="checkbox" value="{$dato.id}" id="id_cajeros[]" onclick="generardeposito()"></td>         
            		</tr>
        ...
        <br>
        <form method='POST' action='generar_deposito_fin.php' name='form1' >
