                    ...
                    <table style="width:100%; background-color:white;">
                        ...
                        <tbody>
                            <tr>
                                ...
                                {html_options values=$option_values_tipo output=$option_output_tipo selected=$tipo_toma}
                                </select>
                                </td>
                                ...
                                {html_options output=$option_output_almacen values=$option_values_almacen selected=$almacen_entrada}
                                </select>
                                </td>
