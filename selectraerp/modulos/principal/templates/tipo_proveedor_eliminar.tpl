...
<tr>
    ...
    <td >
        <input type="text" name="clasificacion" readonly value="{$datos_banco[0].clasificacion}" size="60" id="clasificacion" >
    </td>
</tr>
</table>
...
<table width="100%" border="0">
    ...
    <td>
        <input type="submit" name="eliminar" id="aceptar" value="Eliminar Entidad">
    </td>
    </tr>
    </tbody>
</table>
