        ...
        <form name="formulario" id="formulario">
            <div id="datosGral" class="x-hide-display">
                ...
                <table style="width:50%; background-color:white;" cellpadding="1" cellspacing="1" class="seleccionLista" align="center">
                    <thead>
                        <tr>
                            <th class="tb-head" style="text-align:center;" colspan="5">Generar Cataporte cheque para Punto de Venta: {$parametros[0].codigo_siga}</th>
                        </tr>       
                        <tr>
                        	<td align="left">N°</td>
                		...
                		<tr>
        	                ...
        	                <td align="center">
                                {if $dato.monto_acumulado_cheque <= '0.00'}
                                    <p>Sin cheque <p>
                                {else}
