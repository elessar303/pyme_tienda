...
<script language="JavaScript">
    $(document).ready(function(){
        ...
        $("#formulario").submit(function(){
                if($("#descripcion_linea").val()==""){
                    alert("Debe Ingresar la descripción de Linea!.");
                    $("#descripcion_linea").focus();
                    return false;
                }
...
<tr>
    ...
    <td >
        <input type="text" readonly name="cod_linea" value="{$datos_linea[0].id}" id="cod_linea" >
    </td>
</tr>
<tr>
    <td valign="top"  colspan="3" width="30%" class="tb-head" >
    ...
    <td >
        <input type="text" name="descripcion_linea" readonly value="{$datos_linea[0].marca}" size="60" id="descripcion_linea" >
    </td>
</tr>
</table>
...
<table width="100%" border="0">
    ...
    <td>
        <input type="submit" name="aceptar" id="aceptar" value="Eliminar Linea">
    </td>
    </tr>
    </tbody>
</table>
