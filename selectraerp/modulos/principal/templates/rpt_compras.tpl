...
function valida_envia(){
	...
	if (document.formulario.radio[1].checked){
			window.open('../../reportes/rpt_compras_efectuadas.php?fecha='+fecha+'&fecha_hasta='+fecha_hasta);
	}else{
...
<tr>
<td  class="tb-tit">
<img src="../../libs/imagenes/118.png" width="20" align="absmiddle" height="20">  <b>Listado de Compras Efectuadas</b>
</td>
</tr>
</tbody>
</table>
