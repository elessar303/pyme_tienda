...
{else}
    ...
    {/if}
        ...
        <td>{$campos.banco}</td>
        <td>
<img  style="cursor: pointer;" class="editar"  onclick="javascript: window.location.href='?opt_menu={$smarty.get.opt_menu}&opt_seccion={$smarty.get.opt_seccion}&opt_subseccion=edit&cod={$campos.id}&pagina={$pagina}'" title="Editar" src="../../libs/imagenes/edit.gif">
<img  style="cursor: pointer;" class="eliminar" onclick="javascript: window.location.href='?opt_menu={$smarty.get.opt_menu}&opt_seccion={$smarty.get.opt_seccion}&opt_subseccion=delete&cod={$campos.id}&pagina={$pagina}'" title="Eliminar"  src="../../libs/imagenes/delete.gif">
        </td>
    </tr>
