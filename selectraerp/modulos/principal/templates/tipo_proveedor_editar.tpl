...
<tr>
    ...
    <td >
        <input type="text" readonly name="id_pclasif" value="{$datos_banco[0].id_pclasif}" id="id_pclasif">
    </td>
</tr>
<tr>
    <td valign="top"  colspan="3" width="30%" class="tb-head" >
    ...
    <td >
        <input type="text" name="clasificacion" value="{$datos_banco[0].clasificacion}" size="60" id="clasificacion" >
    </td>
</tr>
</table>
