                            ...
                            <td width="75">
                                <table style="cursor: pointer;" class="btn_bg" onClick="javascript:window.location='?opt_menu={$smarty.get.opt_menu}&opt_seccion={$smarty.get.opt_seccion}&opt_subseccion=add'" name="buscar" border="0" cellpadding="0" cellspacing="0">
                                    <tr>
                                        ...
                                        <td class="btn_bg" nowrap style="padding: 0px 4px;">Agregar Cliente</td>
...
{else}
    ...
    {/if}
            ...
            <td>
                <img style="cursor: pointer;" class="editar" onclick="javascript: window.location.href='?opt_menu={$smarty.get.opt_menu}&opt_seccion={$smarty.get.opt_seccion}&opt_subseccion=edit&cod={$campos.id_cliente}'" title="Editar Cliente" src="../../libs/imagenes/edit.gif">
            {if ($campos.estado eq "A") }
                <img style="cursor: pointer;" class="newfactura" onclick="javascript: window.location.href='?opt_menu={$smarty.get.opt_menu}&opt_seccion={$smarty.get.opt_seccion}&opt_subseccion=presupuesto_nuevo&cod={$campos.id_cliente}'" title="Nuevo Presupuesto/Cotizacion"  src="../../libs/imagenes/factu.png">
            {/if}

            {if ($campos.estado eq "B") }
                <img title="Cliente Bloqueado" src="../../libs/imagenes/ico_note_1.gif">
            {/if}
