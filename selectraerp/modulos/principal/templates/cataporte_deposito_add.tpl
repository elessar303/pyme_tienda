        ...
        <form name="formulario" id="formulario">
            <div id="datosGral" class="x-hide-display">
                ...
                <table style="width:50%; background-color:white;" cellpadding="1" cellspacing="1" class="seleccionLista" align="center">
                    <thead>
                        <tr>
                            <th class="tb-head" style="text-align:center;" colspan="5">Generar Cataporte deposito para Punto de Venta: {$parametros[0].codigo_siga}</th>
                        </tr>       
                        <tr>
                        	<td align="left">N°</td>
                		...
                		<tr>
        	                ...
        	                <td align="center">{$dato.fecha_creacion|date_format:"%d-%m-%Y"}</td>
        	                <td align="center">{$dato.nro_deposito}</td>
                            <td align="center">{$dato.monto|number_format:2:".":""}</td>
        	                <td align="center">
                                {if $dato.monto <= '0.00'}
                                    <p>Sin deposito <p>
                                {else}
                                    <input type="radio" value="{$dato.id}" name="id_depositos[]" id="id_depositos[]" onclick="generardeposito();" />
                                {/if}
