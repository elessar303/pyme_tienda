...
function calcularMonto(precio, utilidad, campoiva, ocultos){
    ...
    if (exonerado.value == '1'){
            iva.value = 0;// Cambiar cero (0) el valor para guardarlo en campo 'iva' de la tabla 'item'
            campoiva.value = precio.value;
        }
        else{
            iva.value = {/literal}{$parametros_generales[0].porcentaje_impuesto_principal}{literal};// Cambiar al valor configurado IVA para guardarlo en campo 'iva' de la tabla 'item'
...
<tr>
    ...
    <td >
        <input type="text" disabled="true" name="ultimo_codigo" id="ultimo_codigo" size="60"  value="{$nro_productoOLD}">
...
<tr>
    ...
    <td >
        <input type="text" name="cod_item" readonly id="cod_item" size="60"  value="{$nro_productoNEW}">
        <div id="notificacionVCoditem"></div>
    </td>
</tr>
<tr>
...
<tr>
    <td colspan="3" class="tb-head">Código de barras</td>
    <td>
        <input type="text" name="cod_barras" id="cod_barras" size="60"  value="{$campos_item[0].codigo_barras}">
    </td>
</tr>
<tr>
    <td colspan="3" class="tb-head">
...
<table width="100%">
    <tr>
        <td>
            ...
            <table>
                <tr>
                    <td colspan="4" class="tb-head" align="center">&nbsp;</td>
                </tr>
                <tr>
                    <td class="tb-head" colspan="4" align="center" width="180"></td>
                </tr>
                <tr>
                    <td class="tb-head" colspan="3" align="right">&nbsp;&nbsp;&nbsp;</td>
                    <td>
                        <table id="tabla_total" style="border: 1px solid #507e95; background-gcolor: white;">
                            <thead>
                                <tr>
                            ...
                            <tbody>
                                <tr>
                                    <td><input type='text' name='ocultos1' id='ocultos1'  value="{$campos_item[0].p1}" onchange="calcular_todo();" size="9"/></td>
  ...
  <tr>
       ...
       <td>
           <select name="monto_exento" id="monto_exento" onchange="calcular_todo();">
               ...
               <option value="1" {if $valor_iva[0].iva == 0} selected {/if}>Si</option>
           </select>
      </td>
</tr>
<tr class="monto_iva">
      <td colspan="3" class="tb-head" align="left">I.V.A</td>
       <td>
