...
<html>
    <head>
        ...
        <script language="JavaScript" type="text/JavaScript">
            ...
            function generardeposito() 
            {
                ...
                parametros = {"arreglo" : checkboxValues, "opt" : "calcular_monto_cataporte_tarjeta"}
                $.ajax(
                {
                    type: "POST",
    ...
    <body>
        <form name="formulario" id="formulario">
            <div id="datosGral" class="x-hide-display">
                ...
                <table style="width:50%; background-color:white;" cellpadding="1" cellspacing="1" class="seleccionLista" align="center">
                    <thead>
                        <tr>
                            <th class="tb-head" style="text-align:center;" colspan="5">Generar Cataporte Tarjeta para Punto de Venta: {$parametros[0].codigo_siga}</th>
                        </tr>       
                        <tr>
                        	<td align="left">N°</td>
                        	<td align="center">Fecha de Transferencia</td>
                        	<td align="center">N° de Transferencia</td>
                        	<td align="center">Monto Tarjeta Acumulado</td>
                		...
                		<tr>
                            ...
                            <td align="center">{$dato.monto_acumulado_tarjeta|number_format:2:".":""}</td>
        	                <td align="center">
                                {if $dato.monto_acumulado_tarjeta <= '0.00'}
                                    <p>Sin tarjeta <p>
                                {else}
        ...
        <br>
        <form method='POST' action='generar_cataporte_fin_tarjeta.php' name='form1' >
