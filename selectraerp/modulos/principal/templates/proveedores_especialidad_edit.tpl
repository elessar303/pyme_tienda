        ...
        <tr class="row-br">
            <td>
                <table class="tb-tit" cellspacing="0" cellpadding="1" border="0" width="100%">
                    <tbody>
                        <tr>
                        <td width="900"><span style="float:left"><img src="{$subseccion[0].img_ruta}" width="22" height="22" class="icon" />{$subseccion[0].especialidad}</span></td>
                        <td width="75">
...
<tr>
    ...
    <td >
        <input type="text" readonly name="cod_especialidad" value="{$datos_banco[0].cod_especialidad}" id="cod_especialidad" >
    </td>
</tr>
<tr>
    <td valign="top"  colspan="3" width="30%" class="tb-head" >
    ...
    <td >
        <input type="text" name="especialidad" value="{$datos_banco[0].especialidad}" size="60" id="especialidad" >
    </td>
</tr>
</table>
