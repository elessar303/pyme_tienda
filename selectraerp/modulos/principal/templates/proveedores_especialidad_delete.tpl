...
<tr>
    ...
    <td >
        <input type="text" name="especialidad" readonly value="{$datos_banco[0].especialidad}" size="60" id="especialidad" >
    </td>
</tr>
</table>
...
<table width="100%" border="0">
    ...
    <td>
        <input type="submit" name="eliminar" id="aceptar" value="Eliminar Especialidad">
    </td>
    </tr>
    </tbody>
</table>
