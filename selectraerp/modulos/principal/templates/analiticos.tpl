...
<form name="formulario" id="formulario" method="POST" onsubmit="return valida_envia()" action="procesar11.php">
...
<tr>
<td  class="tb-tit">
<img src="../../libs/imagenes/118.png" width="20" align="absmiddle" height="20">  <b>Listado de Analiticos</b>
</td>
</tr>
</tbody>
</table>
