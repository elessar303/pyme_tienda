        ...
        <form name="formulario" id="formulario" method="post">
            ...
            <div class="contenedor_factura" style="width:99%; float:left;">
                <div class="contenedor_factura" style="width:50%; height:10%; float:left;">
                    ...
                    <img alt="Sin Foto" src="../../imagenes/{$datacliente[0].foto}" title="Cliente: {$datacliente[0].nombre}" style="width: 70px;border: 1px solid #E7E6E6;padding: 5px;float: left;height: 60px;"/>
                    {else}
                    <img alt="Sin Foto" src="../../imagenes/sin_imagen.jpg" title="Cliente: {$datacliente[0].nombre}" style="width: 70px;border: 1px solid #E7E6E6;padding: 5px;float: left;height: 60px;"/>
                    {/if}
