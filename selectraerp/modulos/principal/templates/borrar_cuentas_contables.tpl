...
<tr>
    ...
    <td >
        <input type="text" readonly name="nro_cuenta"  size="60" value="{$datos_banco[0].nro_cuenta}" id="nro_cuenta" >
        <input type="hidden" value="{$datos_banco[0].id}" name="id" />
    </td>
</tr>
<tr>
    <td valign="top"  colspan="3" width="30%" class="tb-head" >
    ...
    <td >
        <input type="text" name="descripcion" value="{$datos_banco[0].descripcion}" size="60" id="descripcion" >
    </td>
</tr>
 <tr>
        <td valign="top"  colspan="3" width="30%" class="tb-head" >
     ...
     <td >
        ...
        {html_options values=$option_values_precio selected=$option_selected_cuentas output=$option_output_precio}
        </select>
