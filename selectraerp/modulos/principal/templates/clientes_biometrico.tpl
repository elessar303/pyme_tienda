        ...
        {literal}
            <script type="text/javascript">
                $(document).ready(function(){
                    //window.location=window.confirm("Desea continuar?")?"../../reportes/clientes_biometrico.php":"?opt_menu=106";
                    window.open("../../reportes/clientes_biometrico_fpdf.php");
                });
            </script>
        {/literal}
    </head>
                ...
                <table style="width:100%; background-color:white;">
                    ...
                    <tbody>
                     ...
                     <!--    <tr>
                        ...
                        <tr class="tb-tit">
                            <td colspan="6">
                                <input type="submit" id="aceptar" name="aceptar" value="Enviar" onclick="javascript:valida_envia('rpt_venta_productos.php','rpt_venta_productos_xls.php');" />
