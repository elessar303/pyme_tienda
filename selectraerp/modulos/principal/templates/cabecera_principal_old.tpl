            ...
            <td>
                ...
                <table style="width:100%">
                    <tr>
                        ...
                        <td style="background-color: #517D96"><span style="color:#FFF;"><b>{$nombre}</b> ({$stringLoginUsuario}) de <b>{$DatosGenerales[0].nombre_empresa} - Version: {$version[0].version}</b></span></td>
