...
if(isset($_POST['cajero']))
  $cajero=1;
    ...
    $instruccion = "
    INSERT INTO usuarios (`usuario`, `nombreyapellido`, `clave`, `departamento`, vendedor)
    VALUES ('" . $_POST["usuario"] . "', '" . $_POST["nombreyapellido"] . "', '" . $_POST["clave1"] . "', '" . $_POST["cod_unidad"] . "', ".$cajero.");";
