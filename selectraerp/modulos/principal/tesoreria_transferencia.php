...
if (isset($_POST['buscar']) || $tipob != NULL) {
    ...
    $instruccion = "SELECT tr.*,
	pro.descripcion,
	est.descripcion as descest,
	case tr.tipo_transaccion when 1 then 'Transferencia Proveedores' else 'Cheque de Gerencia' end as tipo
	FROM  " . $tabla . " tr left join proveedores pro on (pro.id_proveedor=tr.proveedor_fk) left join estatus est on (est.cod_estatus=tr.estatus) where tr.tesor_bancodet_fk=" . $_GET["cod_cuenta"];
}
...
$smarty->assign("cabecera", array("Tipo", "N&uacute;m. Transf.", "Proveedor", "Concepto", "Fecha", "Monto", "Estatus"));
...
$smarty->assign("cod_cuenta", $cod_cuenta);
?>
