...
if (isset($_POST['buscar']) || $tipob != NULL) {
    ...
    $instruccion = $instruccion . " and id_tipo_movimiento_almacen=5 order by id_transaccion desc";
    //echo $instruccion; exit();
    //exit(0);
} else {
    $instruccion = "SELECT * FROM $tabla as k inner join tipo_movimiento_almacen as t on k.tipo_movimiento_almacen=t.id_tipo_movimiento_almacen where id_tipo_movimiento_almacen=('5') order by id_transaccion desc ";
}
