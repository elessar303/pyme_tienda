...
$comunes = new Comunes();
$tabla = $name_form = "almacenes_siga";
$tipob=@$_GET['tipo'];
$des=@$_GET['des'];
$pagina=@$_GET['pagina'];
...
$smarty->assign("cabecera",array("ID","Código SIGA", "Descripción"));
...
//**************************************************************************
$smarty->assign("option_values", array("id_almacen_siga","codigo_almacen_siga", "descripcion"));
$smarty->assign("option_output", array("ID", "Cod. Almacen","Descripción"));
