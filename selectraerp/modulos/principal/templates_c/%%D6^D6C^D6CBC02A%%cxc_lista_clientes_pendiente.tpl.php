<?php /* Smarty version 2.6.21, created on 2016-09-15 13:20:01
         compiled from cxc_lista_clientes_pendiente.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'html_options', 'cxc_lista_clientes_pendiente.tpl', 49, false),)), $this); ?>
<?php echo '
...
?>
    ...
    <?php else: ?>
        <tr  bgcolor="#e1e1e1">
    <?php endif; ?>
        <td ><?php echo $this->_tpl_vars['campos']['cod_cliente']; ?>
</td>
        <td><?php echo $this->_tpl_vars['campos']['nombre']; ?>
</td>
        <td><?php echo $this->_tpl_vars['campos']['rif']; ?>
</td>
        <td><?php echo $this->_tpl_vars['campos']['telefonos']; ?>
</td>
        <td>
            <img style="cursor: pointer;" class="edocuenta" onclick="javascript: window.location.href='?opt_menu=<?php echo $_GET['opt_menu']; ?>
&opt_seccion=<?php echo $_GET['opt_seccion']; ?>
&opt_subseccion=pendienteFactura&cod=<?php echo $this->_tpl_vars['campos']['id_cliente']; ?>
'" title="Facturas Pendientes"  src="../../libs/imagenes/edocuenta.png">
        </td>
    </tr>
