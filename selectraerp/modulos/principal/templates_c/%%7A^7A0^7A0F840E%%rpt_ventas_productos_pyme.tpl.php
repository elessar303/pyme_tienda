<?php /* Smarty version 2.6.21, created on 2019-09-25 09:27:02
         compiled from rpt_ventas_productos_pyme.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'date_format', 'rpt_ventas_productos_pyme.tpl', 82, false),array('function', 'html_options', 'rpt_ventas_productos_pyme.tpl', 118, false),)), $this); ?>
<!DOCTYPE html>
<html>
    <head>
...
' readonly class="form-text" />
                        ...
                        <tr class="tb-tit">
                            <td colspan="6">
                                <input type="submit" id="aceptar" name="aceptar" value="Enviar" onclick="javascript:valida_envia('rpt_venta_productos_pyme.php','rpt_venta_productos_pyme_xls.php');" />
