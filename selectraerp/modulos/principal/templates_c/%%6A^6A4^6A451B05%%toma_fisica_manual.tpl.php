<?php /* Smarty version 2.6.21, created on 2019-07-02 09:22:34
         compiled from toma_fisica_manual.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'html_options', 'toma_fisica_manual.tpl', 71, false),)), $this); ?>
<!DOCTYPE html>
<html>
    <head>
...
unset($_smarty_tpl_vars);
 ?>
    ...
    <body>
        <form name="formulario" id="formulario" method="post"  target="_blank" action="../../reportes/realizar_toma_fisica.php">
