<?php /* Smarty version 2.6.21, created on 2017-08-02 10:27:12
         compiled from cataporte_ticket_add.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'date_format', 'cataporte_ticket_add.tpl', 231, false),array('modifier', 'number_format', 'cataporte_ticket_add.tpl', 233, false),)), $this); ?>
<!DOCTYPE html>
<html>
    <head>
 ...
 ?>
        ...
        <script language="JavaScript" type="text/JavaScript">
            ...
            function generardeposito() 
            {
                ...
                parametros = {"arreglo" : checkboxValues, "opt" : "calcular_monto_cataporte_tickets"}
                $.ajax(
                {
                    type: "POST",
...
<?php echo ';
                ...
                $.ajax(
                {
                    type: "POST",
                    url: "../../libs/php/ajax/ajax.php",
                    data: {"opt": "MontoAcumulado", "tipo": 1} ,
                    dataType: "html",
                    asynchronous: false,
                ...
                if(document.form1.monto_usuario.value==\'\' )
                {
                    alert(\'Debe Ingresar el Monto\');
                    document.form1.monto_usuario.focus();
                    return false;
                }
                if(document.form1.monto_usuario.value > acumulado)
                {
                    alert(\'El monto ingresado es mayor al acumulado\');
                    document.form1.monto_usuario.focus();
                     return false;
                }
...
unset($_smarty_tpl_vars);
 ?>
                <table style="width:50%; background-color:white;" cellpadding="1" cellspacing="1" class="seleccionLista" align="center">
                    <thead>
                        <tr>
                            <th class="tb-head" style="text-align:center;" colspan="5">Generar Cataporte Tickets para Punto de Venta: <?php echo $this->_tpl_vars['parametros'][0]['codigo_siga']; ?>
</th>
                        </tr>       
                        <tr>
                        	<td align="left">N°</td>
                        	...
                        	<td align="center">Monto Ticket Acumulado</td>
...
?>
                		<tr>
                            ...
                            <td align="center"><?php echo ((is_array($_tmp=$this->_tpl_vars['dato']['monto_acumulado_tickets'])) ? $this->_run_mod_handler('number_format', true, $_tmp, 2, ".", "") : number_format($_tmp, 2, ".", "")); ?>
</td>
        	                <td align="center">
                                <?php if ($this->_tpl_vars['dato']['monto_acumulado_tickets'] <= '0.00'): ?>
                                    <p>Sin tickets <p>
                                <?php else: ?>
...
" id="id_depositos[]" onclick="generardeposito();" />
        ...
        <br>
        <form method='POST' action='generar_cataporte_fin_tickets.php' name='form1' >
