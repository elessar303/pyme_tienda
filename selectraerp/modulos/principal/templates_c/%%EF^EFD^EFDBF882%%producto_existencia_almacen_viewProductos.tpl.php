<?php /* Smarty version 2.6.21, created on 2019-06-05 16:20:20
         compiled from producto_existencia_almacen_viewProductos.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'html_options', 'producto_existencia_almacen_viewProductos.tpl', 58, false),)), $this); ?>
<?php echo '
...
&opt_subseccion=viewProductos&cod=<?php echo $_GET['cod']; ?>
" method="POST">
    <table width="100%">
        <tr class="row-br">
            <td>
...
" width="22" height="22" class="icon" /><?php echo $this->_tpl_vars['subseccion'][0]['descripcion']; ?>
 - Nombre del Almacen: <b><?php echo $this->_tpl_vars['descripcion_almacen'][0]['descripcion']; ?>
 - Codigo: <?php echo $this->_tpl_vars['descripcion_almacen'][0]['cod_almacen']; ?>
</b></span></td>
                        <td width="75">
                        <table style="cursor: pointer;" class="btn_bg" onClick="javascript:window.location='?opt_menu=<?php echo $_GET['opt_menu']; ?>
&opt_seccion=<?php echo $_GET['opt_seccion']; ?>
&opt_subseccion=add&cod=<?php echo $_GET['cod']; ?>
...
?>
    ...
    <?php endif; ?>
		...
		<td><?php echo $this->_tpl_vars['campos']['cantidad']; ?>
</td>

        <td>
            <img  style="cursor: pointer;" class="editar"  onclick="javascript: window.location.href='?opt_menu=<?php echo $_GET['opt_menu']; ?>
&opt_seccion=<?php echo $_GET['opt_seccion']; ?>
&opt_subseccion=edit&cod=<?php echo $_GET['cod']; ?>
&cod2=<?php echo $this->_tpl_vars['campos']['id_item']; ?>
...
&opt_seccion=<?php echo $_GET['opt_seccion']; ?>
&opt_subseccion=delete&cod=<?php echo $_GET['cod']; ?>
&cod2=<?php echo $this->_tpl_vars['campos']['id_item']; ?>
