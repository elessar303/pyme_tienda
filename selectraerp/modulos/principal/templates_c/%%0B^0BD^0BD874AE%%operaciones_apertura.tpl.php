<?php /* Smarty version 2.6.21, created on 2018-08-28 09:40:52
         compiled from operaciones_apertura.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'html_options', 'operaciones_apertura.tpl', 48, false),)), $this); ?>
<?php echo '
...
?>
    ...
    <?php else: ?>
        <tr  bgcolor="#e1e1e1">
    <?php endif; ?>
        <td align="center"><?php echo $this->_tpl_vars['campos']['operacion']; ?>
</td>
        <td align="center">
          <?php if (( $this->_tpl_vars['campos']['status'] == '1' )): ?>
          <img title="Dep&oacute;sito con Cataporte" src="../../../includes/imagenes/ico_ok.gif"/>
          <?php else: ?>
          <img title="Dep&oacute;sito sin Cataporte" src="../../../includes/imagenes/ico_delete.gif"/>
          <?php endif; ?>
        </td>
        <td align="center">
