<?php /* Smarty version 2.6.21, created on 2016-08-10 20:00:51
         compiled from rpt_venta_productos4.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'date_format', 'rpt_venta_productos4.tpl', 147, false),array('function', 'html_options', 'rpt_venta_productos4.tpl', 171, false),)), $this); ?>
<!DOCTYPE html>
<html>
    <head>
        ...
        <style type="text/css">
            ...
            $(document).ready(function(){
                ...
                hasta=$("#fecha2").val();
                    ...
                    $.ajax({
                            type: \'GET\',
                            data: "opt=reporte_productoCentral&punto="+punto+"&estados="+estados+"&desde="+desde+"&hasta="+hasta,
