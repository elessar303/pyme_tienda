<?php /* Smarty version 2.6.21, created on 2019-09-26 15:49:18
...
" style="width: 70px;border: 1px solid #E7E6E6;padding: 5px;float: left;height: 70px;"/>
                    <?php else: ?>
...
" style="width: 70px;border: 1px solid #E7E6E6;padding: 5px;float: left;height: 70px;"/>
                    ...
                    <?php if ($this->_tpl_vars['datacliente'][0]['id_cliente'] == 0): ?>
                    ...
                    <span style="font-family:'Verdana';"><b>Establecimiento:&nbsp;</b><select  name="puntodeventa" id="puntodeventa" style="max-width:50%;">
                        ...
                        <?php echo smarty_function_html_options(array('output' => $this->_tpl_vars['option_output_punto'],'values' => $this->_tpl_vars['option_values_punto']), $this);?>
    ...
    <div id="incluirproducto" class="x-hide-display">
        ...
        <p>
            ...
            <select name="cesta" id="cesta" class="form-text" style="width:300px;">
                ...
                <?php echo smarty_function_html_options(array('values' => $this->_tpl_vars['option_values_cesta'],'output' => $this->_tpl_vars['option_output_cesta']), $this);?>
