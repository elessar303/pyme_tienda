<?php /* Smarty version 2.6.21, created on 2019-09-06 13:48:35
         compiled from rpt_venta_vendedor.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'date_format', 'rpt_venta_vendedor.tpl', 81, false),)), $this); ?>
<!DOCTYPE html>
<html>
    <head>
...
' readonly class="form-text" />
                        ...
                        <tr class="tb-tit">
                            <td colspan="6">
                                <input type="submit" id="aceptar" name="aceptar" value="Enviar" onclick="javascript:valida_envia('rpt_venta_vendedor_pos.php','rpt_venta_vendedor_pos_xls.php');" />
