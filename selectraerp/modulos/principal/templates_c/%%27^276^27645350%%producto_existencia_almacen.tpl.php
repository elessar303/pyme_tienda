<?php /* Smarty version 2.6.21, created on 2019-06-05 16:21:02
         compiled from producto_existencia_almacen.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'html_options', 'producto_existencia_almacen.tpl', 63, false),)), $this); ?>
<?php echo '
...
&opt_seccion=55&opt_subseccion=add'" name="buscar" border="0" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td style="padding: 0px;" align="right"><img src="../../libs/imagenes/bt_left.gif" alt="" width="4" height="21" style="border-width: 0px;" /></td>
                                    <td class="btn_bg"><img src="../../libs/imagenes/add.gif" width="16" height="16" /></td>
                                    <td class="btn_bg" nowrap style="padding: 0px 4px;">Agregar Almacen</td>
...
?>
    ...
    <?php else: ?>
        <tr  bgcolor="#e1e1e1">
    <?php endif; ?>
        <td ><?php echo $this->_tpl_vars['campos']['cod_almacen']; ?>
</td>
        <td><?php echo $this->_tpl_vars['campos']['descripcion']; ?>
</td>
        <td>
            <img  style="cursor: pointer;" class="ver_productos"  onclick="javascript: window.location.href='?opt_menu=<?php echo $_GET['opt_menu']; ?>
&opt_seccion=<?php echo $_GET['opt_seccion']; ?>
&opt_subseccion=viewProductos&cod=<?php echo $this->_tpl_vars['campos']['cod_almacen']; ?>
'" title="Ver Productos" src="../../libs/imagenes/ir_a.gif">
        </td>
    </tr>
