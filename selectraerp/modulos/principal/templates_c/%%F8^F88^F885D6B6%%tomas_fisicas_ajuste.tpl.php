<?php /* Smarty version 2.6.21, created on 2019-09-06 09:22:14
         compiled from tomas_fisicas_ajuste.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'date_format', 'tomas_fisicas_ajuste.tpl', 365, false),array('function', 'counter', 'tomas_fisicas_ajuste.tpl', 471, false),)), $this); ?>
<!DOCTYPE html>
<html>
    <head>
...
' readonly class="form-text" />
                                ...
                                <td style="padding-top:2px; padding-bottom: 2px;">
                                <?php echo $this->_tpl_vars['nombre_toma']; ?>

                                </td>
                                
                                <td class="label">Almacen</td>
                                <td  style="padding-top:2px; padding-bottom: 2px;">
                                <?php echo $this->_tpl_vars['nombre_almacen']; ?>

                                </td>

                                <td class="label">Ubicacion:</td>
                                <td style="padding-top:2px; padding-bottom: 2px;">
                                <?php echo $this->_tpl_vars['nombre_ubicacion']; ?>
