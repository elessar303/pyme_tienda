<?php /* Smarty version 2.6.21, created on 2019-05-27 11:38:47
         compiled from reporte_libro_venta.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'date_format', 'reporte_libro_venta.tpl', 92, false),array('function', 'html_options', 'reporte_libro_venta.tpl', 128, false),)), $this); ?>
<!DOCTYPE html>
<html>
    <head>
...
unset($_smarty_tpl_vars);
 ?>
    ...
    <body>
        <form name="formulario" id="formulario" method="post" action="../../reportes/reporte_libro_ventas_total.php">
...
' readonly class="form-text" />
                        ...
                        <tr class="tb-tit">
                            <td colspan="6">
                                <input type="submit" id="aceptar" name="aceptar" value="Enviar" onclick="javascript:valida_envia('reporte_libro_ventas_total.php');" />
