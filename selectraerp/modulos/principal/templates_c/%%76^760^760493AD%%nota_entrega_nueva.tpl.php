<?php /* Smarty version 2.6.21, created on 2016-09-15 12:50:52
         compiled from nota_entrega_nueva.tpl */ ?>
<!DOCTYPE html>
<html>
    <head>
        ...
        <script type="text/javascript" src="../../libs/js/eventos_paneles_documento_mercantil.js"></script>
...
unset($_smarty_tpl_vars);
 ?>
    ...
    <body>
        <?php $_smarty_tpl_vars = $this->_tpl_vars;
$this->_smarty_include(array('smarty_include_tpl_file' => "documento_mercantil.tpl", 'smarty_include_vars' => array()));
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
 ?>
    </body>
