...
$comunes = new Comunes();
$tabla = "operaciones_apertura";
$name_form = "operaciones_apertura";
$tipob=@$_GET['tipo'];
$des=@$_GET['des'];
$pagina=@$_GET['pagina'];
...
if(isset($_POST['buscar']) || $tipob!=NULL){
    ...
    $instruccion = "SELECT * FROM operaciones_apertura ";
}
...
$smarty->assign("cabecera",array("Operación","Estatus", "Opciones"));
...
//**************************************************************************
$smarty->assign("option_values", array("operacion"));
$smarty->assign("option_output", array("Operacion"));
