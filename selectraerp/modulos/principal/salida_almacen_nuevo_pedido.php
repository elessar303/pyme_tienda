...
if (isset($_POST["input_cantidad_items"])) { // si el usuario hizo post
    ...
    $kardex_almacen_instruccion = "
        ...
        `estado`, `fecha_ejecucion`, `id_conductor`,`placa`,`color`,`marca`, prescintos, id_jornada, id_tipo_despacho)
        VALUES (
        NULL, '4', '" . $_POST["autorizado_por"] . "', '" . $_POST["observaciones"] . "',
        '" . $_POST["input_fechacompra"] . "', '" . $login->getUsuario() . "', CURRENT_TIMESTAMP,
        'Entregado', '" . $_POST["input_fechacompra"] . "', '{$id_conductor[0]["id_conductor"]}','" . $_POST["placa"] . "','" . $_POST["color"] . "','" . $_POST["marca"] . "', '" . $_POST["prescintos"] . "', '".$_POST['id_jornada']."', '".$_POST['id_tipo_despacho']."');";
