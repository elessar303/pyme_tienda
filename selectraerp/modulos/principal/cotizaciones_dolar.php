...
if(isset($_POST['buscar']) || $tipob!=NULL){
    ...
    $instruccion = "SELECT * FROM cotizaciones_dolar ORDER BY id DESC";
}
...
$smarty->assign("cabecera",array("Id","Cotizacion","Fecha", "Usuario"));
...
//**************************************************************************
$smarty->assign("option_values", array("cotizacion","fecha"));
$smarty->assign("option_output", array("Cotizacion","Fecha"));
