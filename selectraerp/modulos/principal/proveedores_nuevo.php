...
if (isset($_POST["aceptar"])) {
    ...
    $instruccion = "INSERT INTO `proveedores` (
                    ...
                    `usuario_creacion`, `cuenta_contable`, `cod_impuesto_proveedor`, foto
                    )
                    VALUES (
                    ...
                    '" . $login->getUsuario() . "', '" . $_POST["cuenta_contable"] . "', '" . $_POST["cod_impuesto_proveedor"] . "', '$foto');";

/*
//************************************SERVICIO WEB************************************************
    //Llamada al servicio para insertar el proveedor en SIGA
    $myarreglo = Array ( "proveedor[codpro]" => "".$_POST['rif']."",
                        "proveedor[rifpro]" => "".$_POST['rif']."",
                        "proveedor[nompro]" => "".$_POST['descripcion']."",
                        "proveedor[telpro]" => "".$_POST['telefonos']."",
                        "proveedor[emapro]" => "".$_POST['email']."" );
...
$respuesta_servicio=CallAPI("POST","http://192.168.22.8/compras/cargarProveedor", $myarreglo);
echo "<br>";
echo "<br>"; 
$respuesta_servicio=json_decode($respuesta_servicio, true);
...
//print_r($respuesta_servicio);
echo "<br>"; 
foreach ($respuesta_servicio as $product) {
