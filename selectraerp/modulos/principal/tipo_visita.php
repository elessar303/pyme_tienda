<?php
$comunes = new Comunes();
$tabla = $name_form = "tipo_visitas";
$tipob=@$_GET['descripcion_visita'];
$des=@$_GET['des'];
$pagina=@$_GET['pagina'];
...
$smarty->assign("cabecera",array("id","descripcion_visita"));
...
$smarty->assign("descricion_visita",$tipob);
...
//**************************************************************************
$smarty->assign("option_values", array("id","descripcion_visita"));
$smarty->assign("option_output", array("ID","Nombre Visita"));
