<?php
$comunes = new Comunes();
$tabla = $name_form = "caja_impresora";
$tipob=@$_GET['tipo'];
$des=@$_GET['des'];
$pagina=@$_GET['pagina'];
...
$smarty->assign("cabecera",array("Serial","Caja"));
...
//**************************************************************************
$smarty->assign("option_values", array("serial_impresora","caja_host"));
$smarty->assign("option_output", array("Serial Impresora","Nombre Caja"));
