...
if (isset($_POST["aceptar"]))
{
   ...
   if($_FILES["foto3"]["name"]!="")
    ...
    $instruccion = "
        ...
        foto,foto1,foto2,foto3,foto4,cantidad_bulto,kilos_bulto,proveedor,fecha_ingreso,origen,costo_cif,costo_origen,temporada,mate_compo_clase,
        punto_pedido,tejido, reg_sanit, cod_barra_bulto, observacion, cont_licen_nro, precio_cont, aprob_arte, propiedad,regulado, itempos)
        VALUES(
