...
$instruccion = "SELECT * FROM  ".$tabla." LEFT JOIN ".$tabla_tipomov." ON cod_tipo_movimientos_ban=tipo_movimiento where cod_tesor_bancodet = ".@$_GET["cod_cuenta"]." and id_cliente=0";
...
$smarty->assign("cabecera",array("Codigo","Tipo","Numero","Fecha","Monto","Concepto",""));
