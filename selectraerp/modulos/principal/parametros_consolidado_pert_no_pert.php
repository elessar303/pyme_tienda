...
$smarty->assign("tipo_reporte", "consolidado_pert_no_pert");
$smarty->assign("tipo_producto", "ambos");
$smarty->assign("url_reporte", "../../reportes/excel/consolidado_pertenecientes_no_perteneciente.php");
?>
