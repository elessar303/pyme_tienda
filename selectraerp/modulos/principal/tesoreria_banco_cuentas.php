...
if (isset($_POST['buscar']) || $tipob != NULL) {
    ...
    $instruccion = "SELECT * FROM  " . $tabla . " WHERE cod_banco = " . @$_GET["cod"]." ORDER BY cod_tesor_bandodet";
}
...
$smarty->assign("cabecera", array("C&oacute;digo", "Descripci&oacute;n", "Nro. Cuenta", "Tipo", "Cuenta Contable"));
