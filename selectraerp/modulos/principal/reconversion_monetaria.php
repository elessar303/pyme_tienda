...
$comunes = new Comunes();
$tabla = $name_form = "reconversion_monetaria";
$tipob=@$_GET['tipo'];
$des=@$_GET['des'];
$pagina=@$_GET['pagina'];
...
$smarty->assign("cabecera",array("Tabla","Columna"));
...
//**************************************************************************
$smarty->assign("option_values", array("tabla","columna"));
$smarty->assign("option_output", array("Tabla","Columna"));
