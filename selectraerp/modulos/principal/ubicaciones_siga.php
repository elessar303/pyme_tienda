...
$comunes = new Comunes();
$tabla = $name_form = "ubicaciones_siga";
$tipob=@$_GET['tipo'];
$des=@$_GET['des'];
$pagina=@$_GET['pagina'];
...
$smarty->assign("cabecera",array("ID","Código SIGA Ubicación", "Descripción"));
...
//**************************************************************************
$smarty->assign("option_values", array("id_ubicacion_siga","codigo_ubicacion_siga", "descripcion"));
$smarty->assign("option_output", array("ID", "Cod.SIGA Ubicación","Descripción"));
