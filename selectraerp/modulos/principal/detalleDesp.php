...
$comunes = new Comunes();
$tabla = $name_form = "despacho_detalle";
$tipob=@$_GET['tipo'];
$des=@$_GET['des'];
$pagina=@$_GET['pagina'];
...
$smarty->assign("cabecera",array("item_descripcion","serial"));
...
//**************************************************************************
$smarty->assign("option_values", array("item_descripcion","serial"));
$smarty->assign("option_output", array("Descripcion","Serial"));
