...
if (isset($_POST['buscar']) || $tipob != NULL) {
    ...
    $instruccion = $instruccion . " and tipo_acta=('2') order by fecha desc";
    //exit(0);
} else {
    $instruccion = "SELECT * FROM $tabla as k  where tipo_acta=2 order by fecha desc";
}
...
$smarty->assign("cabecera", array("Transacci&oacute;n", "Fecha", "Autorizado Por", "Descripci&oacute;n"));
