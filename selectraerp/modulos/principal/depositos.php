...
$tabla = $name_form = "caja_principal";
$tipob = @$_GET['tipo'];
$des = @$_GET['des'];
$pagina = @$_GET['pagina'];
...
if (isset($_POST['buscar']) || $tipob != NULL) {
    ...
    $instruccion = "SELECT * FROM $tabla order by fecha_deposito desc";
}
...
$smarty->assign("cabecera", array("Nro de Transferencia", "Nro de Cataporte", "Fecha de Transferencia", "Monto", "Monto Acumulado", "Tarjeta Acumulado", "Deposito Acumulado"));
...
$smarty->assign("option_output", array("Nro de transferencia", "Nro de Cataporte"));
