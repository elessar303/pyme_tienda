...
$sql="Select b.monto, b.id, fecha_creacion, a.nro_deposito from $bd_pyme.caja_principal as a inner join caja_principal_cheques as b on a.nro_deposito=b.id_caja_principal where fecha_deposito!='0000-00-00 00:00:00' and b.estatus=0 and a.id_deposito in (select * from (select id_deposito from caja_principal where fecha_deposito!='0000-00-00 00:00:00' order by id_deposito desc limit 1) as t)";
