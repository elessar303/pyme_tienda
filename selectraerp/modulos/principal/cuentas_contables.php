...
if(isset($_POST['buscar']) || $tipob!=NULL){
    ...
    $instruccion = "SELECT * FROM cuentas_contables ";
}
...
$smarty->assign("cabecera",array("Nro Cuenta","Descripcion","Banco"));
...
//**************************************************************************
$smarty->assign("option_values", array("nro_cuenta","descripcion","banco"));
$smarty->assign("option_output", array("Nro Cuenta","Descripcion", "banco"));
