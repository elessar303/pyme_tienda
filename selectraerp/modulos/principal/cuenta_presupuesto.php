<?php
$comunes = new Comunes();
$tabla = $name_form = "cuenta_presupuestaria";
...
$smarty->assign("cabecera",array("id","Cuenta", "Tipo"));
...
//**************************************************************************
$smarty->assign("option_values", array("id","cuenta",  "tipo"));
$smarty->assign("option_output", array("ID","Cuenta",  "Tipo"));
