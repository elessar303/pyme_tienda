...
if(isset($_POST['buscar']) || $tipob!=NULL){
	if(!$tipob){
		$tipob=$_POST['palabra'];
		$des=$_POST['buscar'];
		$busqueda ="id_almacen= ".$_GET["cod"]." and ". $_POST['busqueda'];
	}
    ...
    $instruccion = "SELECT * FROM ubicacion where id_almacen= ".$_GET["cod"];
}
...
//**************************************************************************
$smarty->assign("option_values", array("id","descripcion"));
$smarty->assign("option_output", array("Cod. ubicacion","Descripción"));
