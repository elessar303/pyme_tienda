...
*/
$datoscampos=$comunes->ObtenerFilasBySqlSelect("select  date_format( a.fecha, '%d-%m-%Y' ) as fecha1, a.* from comprobante as a  where (a.banco is null || a.banco='0.00') ".$inicio." ".$nro);
