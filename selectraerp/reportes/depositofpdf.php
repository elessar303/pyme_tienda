...
/*/$sql="
    ...
    ";*/
    $sql="
    (SELECT a.efectivo as monto_caja, b.monto as monto_efectivo, b.monto_tarjeta, b.monto_deposito,  b.monto_tickets, b.monto_cheque,  c.NAME as host, a.fecha_venta_fin as fecha FROM arqueo_cajero a, caja_principal b, ".POS.".people as c WHERE a.id_deposito = b.nro_deposito AND a.id_deposito='".$nro_deposito."' and a.id_cajero=c.ID)
    union all
    (SELECT a.efectivo as monto_caja, b.monto as monto_efectivo, b.monto_tarjeta, b.monto_deposito,  b.monto_tickets, b.monto_cheque,  c.nombreyapellido as host, a.fecha_venta_fin as fecha FROM arqueo_cajero a, caja_principal b, usuarios as c WHERE a.id_deposito = b.nro_deposito AND a.id_deposito='".$nro_deposito."' and a.id_cajero=c.cod_usuario)
    ";
