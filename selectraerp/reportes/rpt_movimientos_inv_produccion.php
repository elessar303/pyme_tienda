...
class PDF extends FPDF {
    ...
    function Header() {
        ...
        $this->Cell(0, 0, utf8_decode("REPORTE DE TRANSFORMACION"), 0, 0, 'C');
        ...
        $this->SetWidths(array(10, 18,30, 70, 15, 18, 25, 25,25,25, 17));
        $this->SetAligns(array("C","C", "C", "C", "C", "C", "C"));
        $this->Row(array('ID', 'Fecha',utf8_decode('Código'), utf8_decode('Descripción'), 'Unid.','Tipo', 'Almacen Ent', 'Almacen Sal', 'Ubicacion Ent','Ubicacion Sal', 'Referencia'), 1);
    }
...
if($tip_mov!='0')
{
    if($tip_mov=="Transformacion")
    {
        $filtro=" and k.tipo_movimiento_almacen in ('11','12')";
    }
...
$sql = "SELECT k.id_transaccion, k.tipo_movimiento_almacen,  ite.descripcion1, ite.codigo_barras, kad.cantidad AS cantidad, alm.descripcion AS almacen_entrada, a.descripcion AS almacen_salida, ubi.descripcion AS ubicacion_entrada, u.descripcion AS ubicacion_salida, k.fecha, if(k.referencia_salida='0', 'Salida', k.referencia_salida) as referencia_salida
...
LEFT JOIN kardex_almacen AS k2 ON k.id_transaccion = k2.referencia_salida
WHERE 
 k.fecha BETWEEN '{$inicio}' AND '{$final}' 
".$filtro." ORDER BY  k.fecha, k.id_transaccion";
