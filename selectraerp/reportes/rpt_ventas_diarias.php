...
class PDF extends FPDF {
    ...
    function Header() {
        ...
        $fecha = strtoupper("Ventas desde ".@$_GET["fecha"]." hasta ".@$_GET["fecha2"]."");
        $width = 10;
        ...
        $this->Cell(0, 0, utf8_decode("REPORTE DE ").$fecha, 0, 0, 'C');
        $this->Ln(10);
    ...
    function ChapterBody() {
        ...
        $this->SetAligns(array("C", "C", "C", "C", "C", "C", "C", "C", /* "R", */ "C", "C"));
...
$tmp_fecha = strtoupper("Ventas desde '".$fecha."' hasta '".$fecha2."'");
$pdf = new PDF('L', 'mm', 'A4');
$title = 'Ventas por Productos (PYME).';
