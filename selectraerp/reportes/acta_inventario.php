...
$sql="select * from actas_inventario_detalle where id_acta=".$id." and procedencia=2";
...
$html.='</tr><tr><td align="center" colspan="2"><br>Por <b>SEDE CENTRAL</b></td></tr><tr>';
$i=0;
while ($array_por_sede[$i]) {
...
$html.='
<tr>
<td align="center" colspan="2"><br><b>RESPONSABLE</b></td>
</tr>
<tr>
<td align="center" colspan="2">
<br>
_____________________<br>'.$encargado[0]['nombre'].'('.$encargado[0]['cargo'].') <br>V -'.$encargado[0]['cedula'].'</td>
</tr>
</table>
</body>
</html>';
