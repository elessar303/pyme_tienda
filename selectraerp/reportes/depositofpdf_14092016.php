...
$sql="SELECT a.efectivo as monto_caja, b.monto as monto_efectivo,  c.NAME as host, a.fecha_venta_fin as fecha FROM arqueo_cajero a, deposito b, ".POS.".people as c WHERE a.id_deposito = b.nro_deposito AND a.id_deposito='".$nro_deposito."' and a.id_cajero=c.ID";
...
$pdf->Cell(40,5,number_format($monto_caja_format,'2'),1,0,'C');
