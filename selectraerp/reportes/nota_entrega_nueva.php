...
if (isset($_POST["PFactura2"])) { // si el usuario hizo post
    ...
    $nro_factura = $correlativos->getUltimoCorrelativo("cod_nota_entrega", 0, "si");
    ...
    for ($i = 0; $i < (int) $_POST["input_cantidad_items"]; $i++) {
        $detalle_item_instruccion = "INSERT INTO nota_entrega_detalle (
                ...
                `fecha_creacion`, `_item_almacen`, `id_ubicacion`)
            VALUES (
                ...
                CURRENT_TIMESTAMP, '" . $_POST["_item_almacen"][$i] . "', '" . $_POST["_item_ubicacion"][$i] . "');";
        ...
        $kardex_almacen_detalle_instruccion = "
            ...
            VALUES (
                ...
                '" . $_POST["_item_codigo"][$i] . "','" . $_POST["_item_cantidad"][$i] . "', '" . $_POST["_item_ubicacion"][$i] . "');";
    ...
    $nro_facturaOLD = $correlativos->getUltimoCorrelativo("cod_nota_entrega", 1, "no");
    $nro_factura = $correlativos->getUltimoCorrelativo("cod_nota_entrega", 1, "no");
    $factura->ExecuteTrans("UPDATE correlativos SET contador = '" . $nro_factura . "' WHERE campo = 'cod_nota_entrega'");
    $nro_factura -= 1;
