function agregarFactura(){
    ...
    function guardar(){
        ...
        var retencion_iva=$("input[name='retencion_iva']:checked").val();
        var libro_compras=$("input[name='libro_compras']:checked").val();
