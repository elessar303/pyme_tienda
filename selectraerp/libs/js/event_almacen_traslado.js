...
$(".info_detalle").live("click", function(){
            cod = $(this).parent('tr').find("a[rel*=facebox]").text();
               var mask = new Ext.LoadMask(Ext.get("Contenido"), {msg:'Cargando..',removeMask:false});
            $.ajax({
                    type: 'GET',
                    data: 'cod='+cod,
                 ...
                 },
                  {
                     text:'Actualizar lista de Almacenes',
                      ...
                      handler: function(){
                            ...
                            eventos_form.cargarAlmacenesEntrada();
                      }
                 },
                 {
                     text:'Limpiar',
             ...
             buttons:[
                        {
                            ...
                            handler:function(){
                                ...
                                if($("#items").val()==""||$("#almacen_salida").val()==""||$("#almacen_entrada").val()==""||$("#cantidadunitaria").val()==""||$("#cantidadunitaria").val()<0){
                                    Ext.Msg.alert("Alerta","Debe especificar todos los campos.");
                                    return false;
                                }
                                //alert($("#cantidadunitaria").val());
                                //alert($("#cantidad_existente").val())
                                if(($("#cantidadunitaria").val())>($("#cantidad_existente").val())){
        ...
        formpanel_dcompra = new Ext.Panel({
