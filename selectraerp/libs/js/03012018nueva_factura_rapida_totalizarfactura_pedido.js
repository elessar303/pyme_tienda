    ...
    $("input[name='PFactura2']").live("click", function(){
       ...
       // alert(total_acancelar);
        ...
        if(!confirm("Emitir")){
            ...
            var electronico = confirm('¿Pedido con Pago Electronico?');
            ...
            var datos = $("#formulario").serialize()+"&electronico=" + electronico;
                        $.ajax({
                            type: 'POST',
                            data: datos,
                            url: '../../modulos/principal/factura_rapida_nueva_pedido.php',
                            beforeSend: function() {
