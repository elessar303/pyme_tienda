    ...
    $("img.eliminar").live("click",function(){
      ...
      function cargarUbicaciones() {    
       ...
       //reseteo el campo      
        ...
        item=$("#items").val();         
        if(item!='' && codAlmacen!='0' && ubicacion!="" && ubicacion!=2){
            $.ajax({
                type: "GET",
                url:  "../../libs/php/ajax/ajax.php",
                ...
                success: function(data){
                    ...
                    if(resultado[0].id=="-1"){
                        ...
                        //buscar los pendientes y sumar
                            $.ajax({
                type: "GET",
                url:  "../../libs/php/ajax/ajax.php",
                data: "opt=itempendiente&v1="+codAlmacen+"&v2="+item+"&ubicacion="+ubicacion,
                
                  success: function(data){
                    total=0;
                    resultado1= eval(data);
                    $total=0;
                    if(resultado1[0].id!="-1"){
                    
                       total +=resultado1[0].id;


                    $("#cantidad_existente").val(($("#cantidad_existente").val())-(total));
                    }
