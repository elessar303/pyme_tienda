...
case "calcular_arqueo":
            ...
            if(isset($_POST['tipo_venta_pyme']) && $_POST['tipo_venta_pyme']!="1" )
            {
                ...
                if(!empty($fecha_inicio[0]['fecha_fin']))
                {
                    ...
                    */
                    $sql="select c.cod_departamento as coddepartamento, SUM( (c.precio1 * b._item_cantidad) ) AS totalingreso FROM  factura as a, factura_detalle as b, item as c where a.id_factura=b.id_factura and b.id_item=c.id_item 
