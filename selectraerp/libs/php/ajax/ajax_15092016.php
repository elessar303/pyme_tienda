    ...
    $formulario.= "    
      ...
      case "itempendiente" : 
       ...
       /* if($_POST['efectivo']>$_POST['sistema']){
        ...
        $insert=$conn->Execute2("INSERT INTO retiro_efectivo(id_cajero, billetes_100, billetes_50, billetes_20, billetes_10, billetes_5, billetes_2, monedas, cod_usuario, tipo_venta) 
            VALUES
            (   '".$_POST['cajero']."',
                ".$_POST['billete_100'].",
                ".$_POST['billete_50'].",
