...
<table width="800" border="0" align="center">
	...
	<tr>
		<td width="600"></td>
		<td width="150"></td>
		<td width="50" align="right" class="texto10"></td>
	</tr>
</table>
...
<table width="800" border="0" align="center" class="texto10">
  <tbody class="texto10">
	<tr>
		<td width="600"></td>
		<td align="left"><strong>Orden N°: </strong>'.$codigo.'</td>
	</tr>
	<tr>
      <td width="600" align="left" class="texto10"><strong>Señores: </strong>'.$var_compania.'</td>
      <td width="200" align="left" class="texto10"><strong>Fecha de Emisión: </strong>'.fecha($var_fecha).'</td>
    </tr>
	<tr>
		<td><strong>R.I.F.: </strong>'.$var_rif.'</td>
	...
	<tr>
		<td   align="left" class="texto10"></td>
		<td   align="left" class="texto10"><strong>Monto Bs.F: </strong>'.$monto_orden.'</td>
	</tr>
	<tr>
		<td  align="left" class="texto10"><strong>Presente.-</strong></td>
		<td  align="left" class="texto10"><strong>Requisición N°: </strong>'.$id.'</td>
	</tr>
	<tr>
		<td align="left" colspan="2" class="texto10"><strong>Concepto: </strong>'.$var_concepto.'</td>
	</tr>
</tbody>
</table>
<br><br>
<table width="800" border="0" align="center">
	<tr>
		<td  width="100" colspan="7" align="center" class="texto10"><strong>DETALLES MATERIALES</strong></td>
	</tr>
    <tr>
...
function datos_partidas($codigo)
{
	...
	<tbody>
		<tr>
			<td colspan="7" align="center" class="texto10"><strong>PARTIDAS PRESUPUESTARIAS </strong></td>
		</tr>
    	<tr>
